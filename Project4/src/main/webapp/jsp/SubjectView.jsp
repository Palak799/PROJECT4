...
<%@include file="Header.jsp" %>
 ...
 <tr>
	...
	<td><input type="text" name="subjectName" size="40%" placeholder="Enter Subject"  style="width: 285px;height:15px; resize: none;"class="p2"
 ...
 <tr>
   ...
   <td><textarea name="description"  placeholder="Enter Description" style="width: 300px;height:50px; resize: none;"><%=DataUtility.getStringData(bean.getDescription())%></textarea></td>
